...
Thank you to everyone for the support and interest in Blockchain Commons to date, especially including the first adoptors of our specifications and our sustaining sponsors: [Bitmark](https://bitmark.com/), [Blockchainbird](https://github.com/blockchainbird/bird), [CrossBar](https://www.crossbar-inc.com/), [Foundation Devices](https://foundationdevices.com/), [HRF](https://hrf.org/), [Keystone](https://keyst.one/), and [Unchained Capital](https://unchained.com/).
