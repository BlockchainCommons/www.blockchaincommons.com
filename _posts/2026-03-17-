---
title: "Blockchain Commons Supports Global Digital Collaboration Conference"
...
Blockchain Commons came into the GDC conference via our work with Switzerland on Swiss e-ID, where we made an [invited presentation](https://developer.blockchaincommons.com/meetings/2025-10-swiss-eid/) at the Participation Meeting following Swiss adoption of "electronic proof of identity." We are pleased to keep working with the Swiss Confederation as the hosts of GDC and with the other co-organizers of the conference.

GDC is scheduled for September 1-3, 2026 in Geneva, Switzerland. The conference draws approximately 2,000 participants by invitation only. As part of the Advocacy Co-Organizers Group, our coalition of five organizations shares an allocation of 40 invitations—though additional spots may become available if other co-organizer groups don't use their full allocations. [Let us know](mailto:team@blockchaincommons.com) if you'd like to attend or if you have specific topics you'd like to see addressed, and we'll do our best to propose sessions and issue invites as needed!
